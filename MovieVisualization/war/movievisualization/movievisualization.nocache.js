...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "movievisualization" because\n';
  ...
  $wnd.__gwt_activeModules['movievisualization'] = {
    'moduleName' : 'movievisualization',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/movievisualization.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['movievisualization'].superdevmode = true;

  var expectedSuffix = '/movievisualization.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + movievisualization + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:movievisualization';
  var devModeSessionKey = '__gwtDevModeSession:movievisualization';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/movievisualization/movievisualization.nocache.js';
  ...
  $wnd.__gwt_activeModules['movievisualization'].canRedirect = true;
  $wnd.__gwt_activeModules['movievisualization'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING movievisualization';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/movievisualization?user.agent=' + ua + '&_callback=' + callback;
