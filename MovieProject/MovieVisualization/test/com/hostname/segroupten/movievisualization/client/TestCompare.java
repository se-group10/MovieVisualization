...
public class TestCompare {
	...
	public void test() {
		...
		Movie movie1 = new Movie("The Lord of the Rings", new Date(80, 4, 5), "USA", 201, "a", "Horror", "English");
		
		Movie movie2 = new Movie("The Lord of the Rings", new Date(85, 2, 15), "USA", 109, "A", "Horror", "English");
		
		Movie movie3 = new Movie("Harry Potter", new Date(80, 4, 5),"UK", 201, "c", "Horror", "English");
		...
		assertEquals(8, countryTestTwo);
		assertEquals(-8, countryTestThree);
